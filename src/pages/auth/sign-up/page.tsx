    ...
    <>
      ...
      <Stack gap={rem("32px")} className={classes.form}>
        ...
        <Stack gap={'clamp(1.5rem, 2vw, 2rem)'}>
          <Button className={classes.btnContinue} size="xxl" variant="radial-gradient" rightSection={<ContinueIcon />} h={{0: 78, md: 92}} onClick={() => onClick("security-code")}>
            CONTINUE
          </Button>
  ...
  return (
    <>
      ...
      <Stack gap={'clamp(1.5rem, 2vw, 2rem)'} className={classes.form}>
        ...
        <Button size="xxl" className={classes.btnContinue} variant="radial-gradient" rightSection={<ConfirmIcon />} h={{0: 78, md: 92}} fz={{0: 18, md: 24}} onClick={() => onClick("form")}>
          confirm
        </Button>
      </Stack>
    </>
