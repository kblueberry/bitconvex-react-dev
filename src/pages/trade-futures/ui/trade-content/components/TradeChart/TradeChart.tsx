    ...
    <Container padding={48} className={classes.chartContainer}>
      ...
      <ReactApexChart
        ...
        options={{
          ...
          xaxis: {
            type: "datetime",
            min: series[0].data[minZoomIndex].x?.valueOf(),
            max: series[0].data[maxZoomIndex].x?.valueOf(),
            range: series[0].data[maxZoomIndex].x?.valueOf() - series[0].data[minZoomIndex].x?.valueOf(),
            axisBorder: {
