      ...
      <Stack className={classes.contentWrapper}>
        <Container>
          <Stack gap={'clamp(1.5rem, 4vw, 4rem)'} >
            ...
            <Image draggable={false} src={`${import.meta.env.BASE_URL}assets/light/privacy-notice/2.png`} alt="light-2" className={classes.lightTwo}/>
            <Image draggable={false} src={`${import.meta.env.BASE_URL}assets/light/privacy-notice/3.png`} alt="light-3" className={classes.lightThree}/>
              ...
              <Stack gap={'clamp(1rem, 2vw, 2rem)'}>
                ...
                BitConvex Financial Company and its affiliates (hereinafter, ' BitConvex Financial Company', ' BitConvex', 'we', 'us' or 'our') are committed to protecting and respecting your privacy. This Privacy Policy (together with our Terms of Use) governs our collection, processing and use of your Personal Information. We define 'Personal Information' as information which identifies you personally, e.g. your name, address, e-mail address, trades etc.
              ...
              <Stack gap={'clamp(1rem, 2vw, 2rem)'}>
                ...
                <Text fz={{0: 16, md: 20}} color="white">
                BitConvex Australia’s largest fully regulated and licensed AML/CTF compliant AUSTRAC registered Dual Gateway Exchange Platform. Buy, sell, send, receive and trade cryptocurrencies.
              ...
              <Stack gap={'clamp(1rem, 2vw, 2rem)'}>
                ...
                <Text fz={{0: 16, md: 20}} color="white">
                Our Data Protection Officer is the person in charge of ensuring our company adheres to this privacy policy. This person is also the main contact for our Data Protection Supervisory Authority. The Data Protection Officer may be contacted on separate e-mail dpo@ BitConvex.com.
              ...
              <Stack gap={'clamp(1rem, 2vw, 2rem)'}>
                ...
                <Text fz={{0: 16, md: 20}} color="white">
                Please be notified that BitConvex is not in any partnership with entities who represent themselves as customer support agents, providing customer support services via phone and/or social media and promise to help solve your issues for money. Remember - customer support is provided only via the BitConvex website and is always provided free of charge.
