        ...
        <Stack gap={'clamp(1.5rem, 4vw, 4rem)'}>
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <ul style={{ color: "white", paddingLeft: rem(30) }}>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">5th Anti-Money Laundering Directive ((EU) 2018/843)</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">The Proceeds of Crime Act 2002;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Terrorism Act 2000 and 2001;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Counter-Terrorism Act 2008;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">HM Treasury Sanction Notices;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">FCA Handbook.</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">AML/KYC Policy includes:</Text>
                </li>
              </ul>
            </Stack>
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <ul style={{ color: "white", paddingLeft: rem(30) }}>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Verification procedure;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Role of the Chief Compliance Officer;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Transactions Monitoring;</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Risk Assessment:</Text>
                </li>
                <li>
                  <Text fz={{0: 16, md: 20}} color="white">Country of Residence.</Text>
                </li>
              </ul>
            </Stack>
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <Text fz={{0: 16, md: 20}} color="white">
                ...
                <ul style={{ color: "white", paddingLeft: rem(30) }}>
                  ...
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">assess User’s cryptocurrency wallets with regards to AML investigation and compliance.</Text>
                  </li>
                </ul>
              </Text>
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <Text fz={{0: 16, md: 20}} color="white">
                ...
                <ul style={{ color: "white", paddingLeft: rem(30) }}>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">collection of Users’ identification information;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">
                  ...
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">monitoring transactions and investigating any significant deviations from normal activity;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <Text fz={{0: 16, md: 20}} color="white">
                ...
                <ul style={{ color: "white", paddingLeft: rem(30) }}>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">Transparency International;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">Know Your Country;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">FATF High Risk Jurisdictions;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">EU High Risk Jurisdictions;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">Countries where Digital Assets are prohibited or there are restrictions on trading;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">Countries where Digital Assets are not prohibited;</Text>
                  </li>
                  <li>
                    <Text fz={{0: 16, md: 20}} color="white">Countries subject to UNSC Sanctions Regime.</Text>
                  </li>
                </ul>
              </Text>
            ...
            <Stack gap={'clamp(12px, 2vw, 2rem)'} >
              ...
              <Group>
                <Text fz={{0: 16, md: 20}} color="white">
                  <ul style={{ color: "white", paddingLeft: rem(30) }}>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Afghanistan;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Albania;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Angola;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Algeria;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Bangladesh;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Barbados;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Bolivia;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Botswana;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Burma (Myanmar);</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Burundi;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Cambodia;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Central African Republic;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Chad;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Congo;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Guinea – Conakry;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Cote D’ivoire;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Crimea (Ukraine region);</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Cuba;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Democratic People’s Republic of Korea (DPRK);</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Ecuador;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Egypt;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Equatorial Guinea;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Eritrea;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Ghana;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Guinea Bissau;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Guyana;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Haiti;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Iran;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Iraq;</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Jamaica;</Text>
                    </li>
                  </ul>
                </Text>
                <Text fz={{0: 16, md: 20}} color="white">
                  <ul style={{ color: "white", paddingLeft: rem(30) }}>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Lao PDR</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Lebanon</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Libya</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Mali</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Morocco</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Myanmar</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Nepal</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Nicaragua</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">North</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Macedonia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Pakistan</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Panama</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Qatar</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Saudi Arabia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Somalia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">South Sudan</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Afghanistan</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Sudan</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Syria</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Tunisia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Uganda</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Vanuatu</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Afghanistan</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Yemen</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Zimbabwe</Text>
                    </li>
                  </ul>
                </Text>
              </Group>
              ...
              <Group>
                <Text fz={{0: 16, md: 20}} color="white">
                  <ul style={{ color: "white", paddingLeft: rem(30) }}>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Donetsk People’s Republic (DPR)/Luhansk People’s Republic (LPR)</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Pridnestrovian Moldavian Republic</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Nagorno-Karabakh Republic</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of Abkhazia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of Somaliland</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of South Ossetia</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Turkish Republic of Northern Cyprus</Text>
                    </li>
                  </ul>
                </Text>
                <Text fz={{0: 16, md: 20}} color="white">
                  <ul style={{ color: "white", paddingLeft: rem(30) }}>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of China (Taiwan)</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">
                    ...
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of Kosovo</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Sahrawi Arab Democratic Republic</Text>
                    </li>
                    <li>
                      <Text fz={{0: 16, md: 20}} color="white">Republic of Artsakh</Text>
                    </li>
                  </ul>
                </Text>
              </Group>
