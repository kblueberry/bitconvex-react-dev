      ...
      <Stack className={classes.contentWrapper}>
        <Container>
          <Stack gap={'clamp(1.5rem, 4vw, 4rem)'}>
            ...
            <Image draggable={false} src={`${import.meta.env.BASE_URL}assets/light/cookies-policy/2.png`} alt="light-2" className={classes.lightTwo}/>
            <Image draggable={false} src={`${import.meta.env.BASE_URL}assets/light/cookies-policy/3.png`} alt="light-3" className={classes.lightThree}/>
              ...
              <Stack gap={'clamp(12px, 2vw, 2rem)'} >
                ...
                >
                  1. For the Chrome web browser, please visit this page from Google: <a className={classes.link} href="https://support.google.com/accounts/answer/32050">https://support.google.com/accounts/answer/32050</a> <br/>
                  2. For the Internet Explorer web browser, please visit this page from Microsoft: <a className={classes.link} href="http://support.microsoft.com/kb/278835">http://support.microsoft.com/kb/278835</a> <br/>
                  3. For the Firefox web browser, please visit this page from Mozilla: <a className={classes.link} href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored">https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored</a> <br/>
                  4. For the Safari web browser, please visit this page from Apple: <a className={classes.link} href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac">https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac</a> <br/><br/>
