                ...
                steps.map((item,index) =>
                  <>
                    <motion.div custom={index + 1} variants={blockAnimation} className={classes.stepItemWrapper}>
                        <Text className={classes.stepItemNumber}>
                          {item.number}
                        </Text>
                        <Text  className={classes.stepItemTitle}>
                          {item.text}
                        </Text>
                    </motion.div>
                    {
                      index !== steps.length - 1 ? <motion.div custom={index + 1} variants={blockAnimation} ><Divider w={'32px'} className={classes.divider}  size={'2px'} variant="dashed" /> </motion.div> : <></>
                    }
                  </>
                )
              }
      ...
      >
        {steps.map((stepItem) => (
          <li className={classes.gridItem}>
            <div className={classes.gridOrder}>
              {stepItem.number}
            </div>
            <p>
              {stepItem.text}
